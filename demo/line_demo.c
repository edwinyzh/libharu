...
int main (int argc, char **argv)
{
    ...
    const HPDF_REAL DASH_MODE1[] = {3.0f};
    const HPDF_REAL DASH_MODE2[] = {3.0f, 7.0f};
    const HPDF_REAL DASH_MODE3[] = {8.0f, 7.0f, 2.0f, 7.0f};
    ...
    HPDF_Page_SetDash (page, DASH_MODE1, 1, 1.0f);
    draw_line (page, 60, 680, "dash_ptn=[3], phase=1 -- "
                "2 on, 3 off, 3 on...");

    HPDF_Page_SetDash (page, DASH_MODE2, 2, 2.0f);
    draw_line (page, 60, 650, "dash_ptn=[7, 3], phase=2 -- "
                "5 on 3 off, 7 on,...");

    HPDF_Page_SetDash (page, DASH_MODE3, 4, 0.0f);
    draw_line (page, 60, 620, "dash_ptn=[8, 7, 2, 7], phase=0");

    HPDF_Page_SetDash (page, NULL, 0, 0.0f);
    ...
    HPDF_Page_SetDash (page, DASH_MODE1, 1, 0.0f);
