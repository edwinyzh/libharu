...
function HPDF_LoadTTFontFromFile (pdf: HPDF_Doc; const file_name: HPDF_PCHAR;
        embedding: HPDF_BOOL): HPDF_PCHAR; {$IFDEF Linux}cdecl{$ELSE}stdcall{$ENDIF} external LIBHPDF_DLL;
...
function HPDF_PDFA_SetPDFAConformance (pdf: HPDF_Doc;
        pdfatype: THPDF_PDFA_TYPE): HPDF_STATUS; {$IFDEF Linux}cdecl{$ELSE}stdcall{$ENDIF} external LIBHPDF_DLL;		 
